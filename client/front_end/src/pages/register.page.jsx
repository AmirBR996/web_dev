...
const RegisterPage = () => {
  return (
    <main className="h-full w-full flex justify-center items-center">
      <div className="border-2 border-red-700 py-5 px-6 min-h-140 min-w-120 rounded-md shadow-md">
        ...
        <div className="mt-2">
          <p className="text-center">
            ...
            <Link to="/login">
              <span className="text-red-500 italic font-semibold cursor-pointer">
                Login
              </span>
            </Link>
          </p>
